...
namespace Vueling.XXX.Impl.ServiceLibrary.UnitTest.Given_TimeLimitForSeatAssigmentNotExceded
{
    ...
    public class When_AssignSeatsWithTimeLimitValidation
    {
        ...
        public static void ClassInitialize(TestContext context)
        {
            ...
            Sut = new SeatAssignmentApplicationService(seatAssignmentMock.MockObject, GetMapper());
        ...
        private static ILocalMapper GetMapper()
        {
            return new LocalMapper(new MapperService());
        }
